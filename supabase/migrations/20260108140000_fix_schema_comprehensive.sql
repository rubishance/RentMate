...
-- 1. PROPERTIES
CREATE TABLE IF NOT EXISTS public.properties (id uuid PRIMARY KEY DEFAULT gen_random_uuid());
...
-- 3. CONTRACTS
CREATE TABLE IF NOT EXISTS public.contracts (id uuid PRIMARY KEY DEFAULT gen_random_uuid());
