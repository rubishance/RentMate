...
class DashboardCharts {
    ...
    async loadChartData() {
        ...
        const contracts = await window.rentMateDB.getAllContracts();
        const payments = await window.rentMateDB.getAllPayments();
        const properties = await window.rentMateDB.getAllProperties();
