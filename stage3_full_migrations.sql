...
-- STAGE 3: CHRONOLOGICAL MIGRATIONS
...
DROP POLICY IF EXISTS "Users can manage their own preferences" ON user_preferences; CREATE POLICY "Users can manage their own preferences" ON user_preferences
...
-- DROP POLICY IF EXISTS "Users can manage their own payments" ON public.payments; CREATE POLICY "Users can manage their own payments" ON public.payments
...
DROP POLICY IF EXISTS "Enable all access for authenticated users" ON public.payments; CREATE POLICY "Enable all access for authenticated users" ON public.payments
...
-- ADD COLUMN IF NOT EXISTSs for linkage tracking to payments
...
DROP POLICY IF EXISTS "Allow public read access" ON public.saved_calculations; CREATE POLICY "Allow public read access" ON public.saved_calculations for select
...
DROP POLICY IF EXISTS "Allow authenticated insert" ON public.saved_calculations; CREATE POLICY "Allow authenticated insert" ON public.saved_calculations for insert
...
DROP POLICY IF EXISTS "Allow public insert" ON public.saved_calculations; CREATE POLICY "Allow public insert" ON public.saved_calculations for insert
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        DROP POLICY IF EXISTS "Allow public read access to index data" ON index_data; CREATE POLICY "Allow public read access to index data" ON index_data
...
DROP POLICY IF EXISTS "Public Read Plans" ON subscription_plans; CREATE POLICY "Public Read Plans" ON subscription_plans FOR SELECT 
...
DROP FUNCTION IF EXISTS public.manage_session_limits() CASCADE;
...
DROP FUNCTION IF EXISTS get_users_with_stats() CASCADE;
...
-- CREATE OR REPLACE FUNCTION to permanently delete accounts after 14 days

DROP FUNCTION IF EXISTS cleanup_suspended_accounts() CASCADE;
...
DROP POLICY IF EXISTS "Enable insert for everyone" ON public.feedback; CREATE POLICY "Enable insert for everyone" ON public.feedback FOR INSERT
...
DROP POLICY IF EXISTS "Admins can view all feedback" ON public.feedback; CREATE POLICY "Admins can view all feedback" ON public.feedback FOR SELECT
...
DROP POLICY IF EXISTS "Admins can update feedback" ON public.feedback; CREATE POLICY "Admins can update feedback" ON public.feedback FOR UPDATE
...
DROP POLICY IF EXISTS "Anyone can upload feedback screenshots" ON storage.objects; CREATE POLICY "Anyone can upload feedback screenshots" ON storage.objects FOR INSERT
...
DROP POLICY IF EXISTS "Anyone can view feedback screenshots" ON storage.objects; CREATE POLICY "Anyone can view feedback screenshots" ON storage.objects FOR SELECT
...
DROP FUNCTION IF EXISTS check_storage_quota(UUID, BIGINT, TEXT) CASCADE;
...
DROP POLICY IF EXISTS "Public can view calculation shares" ON calculation_shares; CREATE POLICY "Public can view calculation shares" ON calculation_shares FOR SELECT
...
DROP POLICY IF EXISTS "Authenticated users can create shares" ON calculation_shares; CREATE POLICY "Authenticated users can create shares" ON calculation_shares FOR INSERT
...
DROP POLICY IF EXISTS "Anyone can update view count" ON calculation_shares; CREATE POLICY "Anyone can update view count" ON calculation_shares FOR UPDATE
...
DROP FUNCTION IF EXISTS generate_short_id(INTEGER) CASCADE;
...
DROP FUNCTION IF EXISTS create_calculation_share(JSONB) CASCADE;
...
DROP POLICY IF EXISTS "Users can view their property documents" ON property_documents; CREATE POLICY "Users can view their property documents" ON property_documents FOR SELECT

    USING (auth.uid() = user_id);



DROP POLICY IF EXISTS "Users can insert their property documents" ON property_documents; CREATE POLICY "Users can insert their property documents" ON property_documents FOR INSERT

    WITH CHECK (auth.uid() = user_id);



DROP POLICY IF EXISTS "Users can update their property documents" ON property_documents; CREATE POLICY "Users can update their property documents" ON property_documents FOR UPDATE

    USING (auth.uid() = user_id);



DROP POLICY IF EXISTS "Users can delete their property documents" ON property_documents; CREATE POLICY "Users can delete their property documents" ON property_documents FOR DELETE
...
DROP POLICY IF EXISTS "Users can view folders for their properties" ON document_folders; CREATE POLICY "Users can view folders for their properties" ON document_folders FOR SELECT
...
DROP POLICY IF EXISTS "Users can insert folders for their properties" ON document_folders; CREATE POLICY "Users can insert folders for their properties" ON document_folders FOR INSERT
...
DROP POLICY IF EXISTS "Users can update folders for their properties" ON document_folders; CREATE POLICY "Users can update folders for their properties" ON document_folders FOR UPDATE
...
DROP POLICY IF EXISTS "Users can delete folders for their properties" ON document_folders; CREATE POLICY "Users can delete folders for their properties" ON document_folders FOR DELETE
...
DROP POLICY IF EXISTS "Users can view their own property media" ON public.property_media; CREATE POLICY "Users can view their own property media" ON public.property_media FOR SELECT

    USING (auth.uid() = user_id);



DROP POLICY IF EXISTS "Users can insert their own property media" ON public.property_media; CREATE POLICY "Users can insert their own property media" ON public.property_media FOR INSERT

    WITH CHECK (auth.uid() = user_id);



DROP POLICY IF EXISTS "Users can delete their own property media" ON public.property_media; CREATE POLICY "Users can delete their own property media" ON public.property_media FOR DELETE
...
DROP POLICY IF EXISTS "Public can read short links" ON public.short_links; CREATE POLICY "Public can read short links" ON public.short_links FOR SELECT
...
DROP POLICY IF EXISTS "Authenticated users can create short links" ON public.short_links; CREATE POLICY "Authenticated users can create short links" ON public.short_links FOR INSERT
...
DROP POLICY IF EXISTS "Public can create short links" ON public.short_links; CREATE POLICY "Public can create short links" ON public.short_links FOR INSERT
...
DROP POLICY IF EXISTS "Users can view their own storage usage" ON user_storage_usage; CREATE POLICY "Users can view their own storage usage" ON user_storage_usage FOR SELECT
...
DROP FUNCTION IF EXISTS check_ai_chat_usage(UUID, INTEGER) CASCADE;
...
DROP POLICY IF EXISTS "Users can view own AI usage" ON ai_chat_usage; CREATE POLICY "Users can view own AI usage" ON ai_chat_usage FOR SELECT
...
DROP POLICY IF EXISTS "Admins can view all AI usage" ON ai_chat_usage; CREATE POLICY "Admins can view all AI usage" ON ai_chat_usage FOR ALL
...
DROP POLICY IF EXISTS "Anyone can view AI limits" ON ai_usage_limits; CREATE POLICY "Anyone can view AI limits" ON ai_usage_limits FOR SELECT
...
DROP POLICY IF EXISTS "Admins can modify AI limits" ON ai_usage_limits; CREATE POLICY "Admins can modify AI limits" ON ai_usage_limits FOR ALL
...
DROP FUNCTION IF EXISTS public.check_rent_due() CASCADE;
...
DROP FUNCTION IF EXISTS public.get_property_document_counts(UUID) CASCADE;
...
DROP FUNCTION IF EXISTS public.check_daily_notifications() CASCADE;
...
-- 3. CREATE OR REPLACE FUNCTION to check for upcoming extension option deadlines

DROP FUNCTION IF EXISTS public.check_extension_deadlines() CASCADE;
...
-- 2. CREATE OR REPLACE FUNCTION to check for upcoming extension option periods

DROP FUNCTION IF EXISTS public.check_extension_options() CASCADE;
...
DROP POLICY IF EXISTS "Users can view their own usage logs" ON ai_usage_logs; CREATE POLICY "Users can view their own usage logs" ON ai_usage_logs FOR SELECT
...
DROP FUNCTION IF EXISTS check_and_log_ai_usage(UUID, TEXT, INTEGER) CASCADE;
...
DROP POLICY IF EXISTS "Admins can view all storage usage" ON public.user_storage_usage; CREATE POLICY "Admins can view all storage usage" ON public.user_storage_usage FOR SELECT
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'user_profiles') THEN
        ...
        DROP POLICY IF EXISTS "Admins view all" ON public.user_profiles; CREATE POLICY "Admins view all" ON public.user_profiles FOR SELECT 
        ...
        DROP POLICY IF EXISTS "Admins update all" ON public.user_profiles; CREATE POLICY "Admins update all" ON public.user_profiles FOR UPDATE 
...
DROP FUNCTION IF EXISTS public.notify_admin_on_signup() CASCADE;
...
DROP FUNCTION IF EXISTS public.forward_notification_to_email() CASCADE;
...
DROP POLICY IF EXISTS "Broadcasts are viewable by everyone" ON public.system_broadcasts; CREATE POLICY "Broadcasts are viewable by everyone" ON public.system_broadcasts FOR SELECT
...
DROP POLICY IF EXISTS "Super Admins have full access to broadcasts" ON public.system_broadcasts; CREATE POLICY "Super Admins have full access to broadcasts" ON public.system_broadcasts FOR ALL
...
-- 1. CREATE OR REPLACE FUNCTION to generate notification on maintenance record insertion

DROP FUNCTION IF EXISTS public.notify_on_maintenance_record() CASCADE;
...
DROP FUNCTION IF EXISTS notify_admin_of_event() CASCADE;
...
DROP FUNCTION IF EXISTS notify_admin_of_first_payment() CASCADE;
...
DROP FUNCTION IF EXISTS public.notify_admin_on_user_event() CASCADE;
...
DROP FUNCTION IF EXISTS public.notify_admin_on_payment() CASCADE;
...
DROP POLICY IF EXISTS "Admins view all properties" ON public.properties; CREATE POLICY "Admins view all properties" ON public.properties FOR SELECT 
...
DROP POLICY IF EXISTS "Admins view all contracts" ON public.contracts; CREATE POLICY "Admins view all contracts" ON public.contracts FOR SELECT 
...
DROP POLICY IF EXISTS "Admins view all tenants" ON public.tenants; CREATE POLICY "Admins view all tenants" ON public.tenants FOR SELECT 
...
DROP POLICY IF EXISTS "Admins view all payments" ON public.payments; CREATE POLICY "Admins view all payments" ON public.payments FOR SELECT 
...
DROP POLICY IF EXISTS "Admins view all property documents" ON public.property_documents; CREATE POLICY "Admins view all property documents" ON public.property_documents FOR SELECT 
...
DROP POLICY IF EXISTS "Admins view all document folders" ON public.document_folders; CREATE POLICY "Admins view all document folders" ON public.document_folders FOR SELECT 
...
DROP POLICY IF EXISTS "Admins view all short links" ON public.short_links; CREATE POLICY "Admins view all short links" ON public.short_links FOR SELECT 
...
DROP POLICY IF EXISTS "Admins full access to secure_documents" ON storage.objects; CREATE POLICY "Admins full access to secure_documents" ON storage.objects FOR ALL
...
DROP POLICY IF EXISTS "Users can view own tickets" ON support_tickets; CREATE POLICY "Users can view own tickets" ON support_tickets FOR SELECT
...
DROP POLICY IF EXISTS "Users can create tickets" ON support_tickets; CREATE POLICY "Users can create tickets" ON support_tickets FOR INSERT
...
DROP POLICY IF EXISTS "Users can update own open tickets" ON support_tickets; CREATE POLICY "Users can update own open tickets" ON support_tickets FOR UPDATE
...
DROP POLICY IF EXISTS "Admins can view all tickets" ON support_tickets; CREATE POLICY "Admins can view all tickets" ON support_tickets FOR SELECT
...
DROP POLICY IF EXISTS "Admins can update all tickets" ON support_tickets; CREATE POLICY "Admins can update all tickets" ON support_tickets FOR UPDATE
...
DROP POLICY IF EXISTS "Users can view own ticket comments" ON ticket_comments; CREATE POLICY "Users can view own ticket comments" ON ticket_comments FOR SELECT
...
DROP POLICY IF EXISTS "Users can comment on own tickets" ON ticket_comments; CREATE POLICY "Users can comment on own tickets" ON ticket_comments FOR INSERT
...
DROP POLICY IF EXISTS "Admins can view all comments" ON ticket_comments; CREATE POLICY "Admins can view all comments" ON ticket_comments FOR SELECT
...
DROP POLICY IF EXISTS "Admins can comment on all tickets" ON ticket_comments; CREATE POLICY "Admins can comment on all tickets" ON ticket_comments FOR INSERT
...
DROP FUNCTION IF EXISTS sync_user_tier() CASCADE;
...
DROP POLICY IF EXISTS "Admins can view all AI usage logs" ON public.ai_usage_logs; CREATE POLICY "Admins can view all AI usage logs" ON public.ai_usage_logs FOR SELECT
...
DROP FUNCTION IF EXISTS public.log_ai_usage(UUID, TEXT, TEXT, INTEGER, INTEGER) CASCADE;
...
DROP POLICY IF EXISTS "Users can view own AI conversations" ON public.ai_conversations; CREATE POLICY "Users can view own AI conversations" ON public.ai_conversations FOR SELECT
...
DROP POLICY IF EXISTS "Users can delete own AI conversations" ON public.ai_conversations; CREATE POLICY "Users can delete own AI conversations" ON public.ai_conversations FOR DELETE
...
DROP POLICY IF EXISTS "Admins can view all AI conversations" ON public.ai_conversations; CREATE POLICY "Admins can view all AI conversations" ON public.ai_conversations FOR SELECT
...
DROP FUNCTION IF EXISTS public.append_ai_messages(UUID, JSONB, NUMERIC, UUID) CASCADE;
...
DROP POLICY IF EXISTS "Admins manage human conversations" ON public.human_conversations; CREATE POLICY "Admins manage human conversations" ON public.human_conversations
...
DROP POLICY IF EXISTS "Admins manage human messages" ON public.human_messages; CREATE POLICY "Admins manage human messages" ON public.human_messages
...
DROP POLICY IF EXISTS "Users view own human conversations" ON public.human_conversations; CREATE POLICY "Users view own human conversations" ON public.human_conversations
...
DROP POLICY IF EXISTS "Users view/send own human messages" ON public.human_messages; CREATE POLICY "Users view/send own human messages" ON public.human_messages
...
DROP POLICY IF EXISTS "Admins can view all conversations" ON public.human_conversations; CREATE POLICY "Admins can view all conversations" ON public.human_conversations
...
DROP POLICY IF EXISTS "Admins can insert conversations" ON public.human_conversations; CREATE POLICY "Admins can insert conversations" ON public.human_conversations
...
DROP POLICY IF EXISTS "Admins can update conversations" ON public.human_conversations; CREATE POLICY "Admins can update conversations" ON public.human_conversations
...
DROP POLICY IF EXISTS "Users can view their own conversations" ON public.human_conversations; CREATE POLICY "Users can view their own conversations" ON public.human_conversations
...
DROP POLICY IF EXISTS "Admins can view all messages" ON public.human_messages; CREATE POLICY "Admins can view all messages" ON public.human_messages
...
DROP POLICY IF EXISTS "Admins can insert messages" ON public.human_messages; CREATE POLICY "Admins can insert messages" ON public.human_messages
...
DROP POLICY IF EXISTS "Users can view messages in their conversations" ON public.human_messages; CREATE POLICY "Users can view messages in their conversations" ON public.human_messages
...
DROP POLICY IF EXISTS "Users can insert messages in their active conversations" ON public.human_messages; CREATE POLICY "Users can insert messages in their active conversations" ON public.human_messages
...
DROP POLICY IF EXISTS "Admins can view all ticket analysis" ON public.ticket_analysis; CREATE POLICY "Admins can view all ticket analysis" ON public.ticket_analysis
...
DROP POLICY IF EXISTS "Users can view own automation settings" ON public.user_automation_settings; CREATE POLICY "Users can view own automation settings" ON public.user_automation_settings
...
DROP POLICY IF EXISTS "Users can update own automation settings" ON public.user_automation_settings; CREATE POLICY "Users can update own automation settings" ON public.user_automation_settings
...
DROP POLICY IF EXISTS "Users can insert own automation settings" ON public.user_automation_settings; CREATE POLICY "Users can insert own automation settings" ON public.user_automation_settings
...
DROP POLICY IF EXISTS "Admins can manage automation rules" ON public.automation_rules; CREATE POLICY "Admins can manage automation rules" ON public.automation_rules
...
DROP POLICY IF EXISTS "Admins can view automation logs" ON public.automation_logs; CREATE POLICY "Admins can view automation logs" ON public.automation_logs
...
DROP FUNCTION IF EXISTS public.handle_automated_engagement_webhook() CASCADE;
...
DROP FUNCTION IF EXISTS public.queue_storage_cleanup() CASCADE;
...
DROP FUNCTION IF EXISTS public.log_ai_contract_audit(UUID, TEXT, UUID, JSONB) CASCADE;
...
DO $$ BEGIN
    ...
    DROP POLICY IF EXISTS "Allow authenticated read index_data" ON index_data; CREATE POLICY "Allow authenticated read index_data" ON index_data FOR SELECT TO authenticated USING (true);
...
DO $$ BEGIN
    ...
    DROP POLICY IF EXISTS "Allow authenticated read index_bases" ON index_bases; CREATE POLICY "Allow authenticated read index_bases" ON index_bases FOR SELECT TO authenticated USING (true);
...
DO $$ BEGIN
    ...
    DROP POLICY IF EXISTS "Allow full access for service_role index_data" ON index_data; CREATE POLICY "Allow full access for service_role index_data" ON index_data FOR ALL TO service_role USING (true) WITH CHECK (true);
...
DO $$ BEGIN
    ...
    DROP POLICY IF EXISTS "Allow full access for service_role index_bases" ON index_bases; CREATE POLICY "Allow full access for service_role index_bases" ON index_bases FOR ALL TO service_role USING (true) WITH CHECK (true);
...
DROP FUNCTION IF EXISTS public.update_property_status_from_contract() CASCADE;
...
DROP FUNCTION IF EXISTS public.update_property_status_from_contract_v2() CASCADE;
...
DROP FUNCTION IF EXISTS public.archive_expired_contracts() CASCADE;
...
DROP FUNCTION IF EXISTS public.process_daily_notifications_with_archive() CASCADE;
...
DROP POLICY IF EXISTS "Allow authenticated users to read chaining factors" ON chaining_factors; CREATE POLICY "Allow authenticated users to read chaining factors" ON chaining_factors
...
DROP POLICY IF EXISTS "Allow service role to manage chaining factors" ON chaining_factors; CREATE POLICY "Allow service role to manage chaining factors" ON chaining_factors
...
DROP FUNCTION IF EXISTS public.get_supabase_config(TEXT) CASCADE;
...
DROP FUNCTION IF EXISTS public.recalculate_all_property_statuses() CASCADE;
...
DROP POLICY IF EXISTS "Users can view own payments" ON public.payments; CREATE POLICY "Users can view own payments" ON public.payments FOR SELECT USING (user_id = auth.uid());

DROP POLICY IF EXISTS "Users can insert own payments" ON public.payments; CREATE POLICY "Users can insert own payments" ON public.payments FOR INSERT WITH CHECK (user_id = auth.uid());

DROP POLICY IF EXISTS "Users can update own payments" ON public.payments; CREATE POLICY "Users can update own payments" ON public.payments FOR UPDATE USING (user_id = auth.uid());

DROP POLICY IF EXISTS "Users can delete own payments" ON public.payments; CREATE POLICY "Users can delete own payments" ON public.payments FOR DELETE USING (user_id = auth.uid());
...
DROP FUNCTION IF EXISTS public.refresh_schema_cache() CASCADE;
...
DROP POLICY IF EXISTS "Admins can insert plans" ON subscription_plans; CREATE POLICY "Admins can insert plans" ON subscription_plans FOR INSERT
...
DROP POLICY IF EXISTS "Admins can update plans" ON subscription_plans; CREATE POLICY "Admins can update plans" ON subscription_plans FOR UPDATE
...
DROP POLICY IF EXISTS "Admins can delete plans" ON subscription_plans; CREATE POLICY "Admins can delete plans" ON subscription_plans FOR DELETE
...
DROP POLICY IF EXISTS "Allow public read access to rental market data" ON public.rental_market_data; CREATE POLICY "Allow public read access to rental market data" ON public.rental_market_data
...
DROP POLICY IF EXISTS "Admins can read system settings" ON public.system_settings; CREATE POLICY "Admins can read system settings" ON public.system_settings
...
DROP POLICY IF EXISTS "Users view own contracts" ON storage.objects; CREATE POLICY "Users view own contracts" ON storage.objects
...
DROP POLICY IF EXISTS "Users upload own contracts" ON storage.objects; CREATE POLICY "Users upload own contracts" ON storage.objects
...
DROP POLICY IF EXISTS "Users view own images" ON storage.objects; CREATE POLICY "Users view own images" ON storage.objects
...
DROP POLICY IF EXISTS "Users upload own images" ON storage.objects; CREATE POLICY "Users upload own images" ON storage.objects
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'feedback') THEN
        ...
        DROP POLICY IF EXISTS "Users can view own feedback" ON public.feedback; CREATE POLICY "Users can view own feedback" ON public.feedback
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'ai_conversations') THEN
        ...
        DROP POLICY IF EXISTS "Users can view own AI conversations" ON public.ai_conversations; CREATE POLICY "Users can view own AI conversations" ON public.ai_conversations
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'invoices') THEN
        ...
        DROP POLICY IF EXISTS "Users can view own invoices" ON public.invoices; CREATE POLICY "Users can view own invoices" ON public.invoices
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'user_preferences') THEN
        ...
        DROP POLICY IF EXISTS "Users can manage own preferences" ON public.user_preferences; CREATE POLICY "Users can manage own preferences" ON public.user_preferences
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'notifications') THEN
        ...
        DROP POLICY IF EXISTS "Users can manage own notifications" ON public.notifications; CREATE POLICY "Users can manage own notifications" ON public.notifications
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'user_storage_usage') THEN
        ...
        DROP POLICY IF EXISTS "Users can view own storage usage" ON public.user_storage_usage; CREATE POLICY "Users can view own storage usage" ON public.user_storage_usage
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'whatsapp_conversations') THEN
        ...
        DROP POLICY IF EXISTS "Users can view own whatsapp" ON public.whatsapp_conversations; CREATE POLICY "Users can view own whatsapp" ON public.whatsapp_conversations
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'whatsapp_messages') THEN
        ...
        DROP POLICY IF EXISTS "Users can view own whatsapp messages" ON public.whatsapp_messages; CREATE POLICY "Users can view own whatsapp messages" ON public.whatsapp_messages
...
DO $$ BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'user_profiles') THEN
        ...
        DROP POLICY IF EXISTS "Users can view own profile" ON public.user_profiles; CREATE POLICY "Users can view own profile" ON public.user_profiles
        ...
        DROP POLICY IF EXISTS "Users can update own profile" ON public.user_profiles; CREATE POLICY "Users can update own profile" ON public.user_profiles
...
DROP POLICY IF EXISTS "Users can upload own feedback screenshots" ON storage.objects; CREATE POLICY "Users can upload own feedback screenshots" ON storage.objects FOR INSERT
...
DROP POLICY IF EXISTS "Users can view own feedback screenshots" ON storage.objects; CREATE POLICY "Users can view own feedback screenshots" ON storage.objects FOR SELECT
...
DROP POLICY IF EXISTS "Secure Access: Contracts" ON storage.objects; CREATE POLICY "Secure Access: Contracts" ON storage.objects FOR SELECT
...
DROP POLICY IF EXISTS "Secure Access: Property Images" ON storage.objects; CREATE POLICY "Secure Access: Property Images" ON storage.objects FOR SELECT
...
DROP POLICY IF EXISTS "Users can view their own whatsapp usage logs" ON public.whatsapp_usage_logs; CREATE POLICY "Users can view their own whatsapp usage logs" ON public.whatsapp_usage_logs FOR SELECT

    USING (auth.uid() = user_id OR public.is_admin());



DROP POLICY IF EXISTS "Admins can manage all usage logs" ON public.whatsapp_usage_logs; CREATE POLICY "Admins can manage all usage logs" ON public.whatsapp_usage_logs FOR ALL
...
DROP FUNCTION IF EXISTS public.check_and_log_whatsapp_usage(UUID, UUID) CASCADE;
...
DROP POLICY IF EXISTS "Secure Access: Property Images" ON storage.objects; CREATE POLICY "Secure Access: Property Images" ON storage.objects
...
DROP POLICY IF EXISTS "Manual uploads ownership" ON storage.objects; CREATE POLICY "Manual uploads ownership" ON storage.objects FOR ALL
...
DROP POLICY IF EXISTS "Google imports ownership" ON storage.objects; CREATE POLICY "Google imports ownership" ON storage.objects FOR ALL
...
DROP POLICY IF EXISTS "Allow public read access to index_data" ON index_data; CREATE POLICY "Allow public read access to index_data" ON index_data
...
DROP POLICY IF EXISTS "Allow public read access to index_bases" ON index_bases; CREATE POLICY "Allow public read access to index_bases" ON index_bases
...
DROP POLICY IF EXISTS "Allow authenticated users to read index_bases" ON index_bases; CREATE POLICY "Allow authenticated users to read index_bases" ON index_bases
...
DROP POLICY IF EXISTS "Allow anonymous inserts to error_logs" ON public.error_logs; CREATE POLICY "Allow anonymous inserts to error_logs" ON public.error_logs
...
DROP POLICY IF EXISTS "Allow admins to view error_logs" ON public.error_logs; CREATE POLICY "Allow admins to view error_logs" ON public.error_logs
...
DROP POLICY IF EXISTS "Allow admins to update error_logs" ON public.error_logs; CREATE POLICY "Allow admins to update error_logs" ON public.error_logs
...
DROP FUNCTION IF EXISTS public.notify_admin_on_error() CASCADE;
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        DROP POLICY IF EXISTS "Admins can read all analytics" ON public.analytics_events; CREATE POLICY "Admins can read all analytics" ON public.analytics_events
    ...
    IF NOT EXISTS (
        ...
        DROP POLICY IF EXISTS "Users can log their own events" ON public.analytics_events; CREATE POLICY "Users can log their own events" ON public.analytics_events
...
DROP FUNCTION IF EXISTS get_global_usage_stats(INTEGER) CASCADE;
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Admins can view security logs" ON public.security_logs; CREATE POLICY "Admins can view security logs" ON public.security_logs FOR SELECT
...
DROP FUNCTION IF EXISTS public.log_security_event(UUID, TEXT, TEXT, JSONB, TEXT, TEXT) CASCADE;
...
DROP FUNCTION IF EXISTS public.perform_abuse_scan() CASCADE;
...
DROP FUNCTION IF EXISTS public.trigger_daily_admin_summary() CASCADE;
...
DROP POLICY IF EXISTS "Users can only see their own payments" ON public.payments; CREATE POLICY "Users can only see their own payments" ON public.payments 
...
DROP POLICY IF EXISTS "Allow service role to insert debug logs" ON public.debug_logs; CREATE POLICY "Allow service role to insert debug logs" ON public.debug_logs
...
DROP POLICY IF EXISTS "Allow service role to select debug logs" ON public.debug_logs; CREATE POLICY "Allow service role to select debug logs" ON public.debug_logs
...
DROP FUNCTION IF EXISTS public.trigger_index_sync() CASCADE;
