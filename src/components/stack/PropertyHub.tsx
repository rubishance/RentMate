        ...
        <div className="flex flex-col h-full bg-slate-50 dark:bg-black">
            ...
            <div className="relative shrink-0">
                <div className="h-48 bg-slate-200 dark:bg-neutral-800 relative overflow-hidden">
                    <button
                        onClick={() => navigate(-1)}
                        className="absolute top-6 left-6 z-20 p-3 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-white/20 transition-all border border-white/10 group"
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/50 dark:bg-black/50 backdrop-blur-md rounded-full border border-white/20 dark:border-white/10 text-[10px] font-black uppercase tracking-widest mb-2">
                                {(() => {
                                    ...
                                    // Calculate dynamic status if contracts are joined, otherwise fallback to property.status
                                    ...
                                    return (
                                        <>
                                            <div className={cn("w-1.5 h-1.5 rounded-full", isOccupied ? "bg-emerald-500" : "bg-amber-500")} />
