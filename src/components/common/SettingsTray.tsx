                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#0a0a0a] border-t border-border dark:border-white/10 rounded-t-[2.5rem] z-[70] p-8 pb-12 md:hidden"
                            dir={isRtl ? 'rtl' : 'ltr'}
                        >
                            <div className="flex justify-between items-center mb-8">
                                ...
                                <button
                                    onClick={() => setIsOpen(false)}
                                    className="p-2 hover:bg-muted dark:hover:bg-neutral-800 rounded-full transition-colors"
                                >
