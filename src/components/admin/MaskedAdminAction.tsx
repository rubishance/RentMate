    ...
    return (
        <div className={`inline-flex items-center ${className}`}>
            <button
                ...
                disabled={isLogging}
                className="flex items-center gap-2 px-2 sm:px-4 py-2 bg-brand-50 hover:bg-brand-100 text-brand-600 dark:bg-brand-900/20 dark:hover:bg-brand-900/40 rounded-xl transition-all text-xs font-black uppercase tracking-widest border border-brand-100 dark:border-brand-800"
