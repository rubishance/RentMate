...
export const UsageBar: FC<UsageBarProps> = ({ label, current, max, colorClass = "bg-primary" }) => {
    ...
    return (
        <div className="space-y-2">
            ...
            <div className="h-2 w-full bg-muted dark:bg-gray-700 rounded-full overflow-hidden">
                <motion.div
                    initial={{ width: 0 }}
