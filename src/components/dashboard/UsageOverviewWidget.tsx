...
export const UsageOverviewWidget: FC = () => {
        ...
        return (
            <div className="bg-[#0D47A1] rounded-2xl p-8 w-full flex flex-col items-center text-center shadow-lg border border-primary-600 animate-in slide-in-from-top-4 duration-700">
                ...
                <button
                    ...
                    className="w-full sm:w-auto px-8 py-3 bg-white text-[#0D47A1] hover:bg-white/90 transition-colors rounded-xl font-bold text-sm md:text-base shadow-sm"
                >
                    {buttonText}
                </button>
            </div>
    ...
    return (
        <Card className="border-orange-500/20 bg-orange-500/5 h-full animate-in slide-in-from-top-4 duration-700 shadow-minimal hover:shadow-jewel transition-all">
