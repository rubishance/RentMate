        ...
        <div className="space-y-8">
            ...
            {primaryAlert && primaryAlert.id !== 'welcome' && (
                <motion.div
                    ...
                    className={cn(
                        "p-6 rounded-[2.5rem] border flex flex-col md:flex-row items-center gap-6 group cursor-pointer transition-all duration-700",
                ...
                >
                    <div className={cn(
                        "w-16 h-16 rounded-2xl flex items-center justify-center shrink-0 shadow-minimal transition-all group-hover:scale-110 group-hover:rotate-3 duration-700",
                        ...
                        {primaryAlert.type === 'warning' ? <NotificationWarningIcon className="w-7 h-7" /> :
                            primaryAlert.type === 'urgent' ? <NotificationErrorIcon className="w-7 h-7" /> :
                    ...
                    <div className="flex-1 text-center md:text-left rtl:md:text-right space-y-3">
                        ...
                        <h2 className="text-2xl font-black tracking-tight text-foreground lowercase">{primaryAlert.title}</h2>
                        <p className="text-muted-foreground text-sm max-w-xl font-medium opacity-60 leading-relaxed font-sans">{primaryAlert.desc}</p>
                    </div>

                    <div className="shrink-0">
                        <div className="w-12 h-12 rounded-full bg-foreground text-background flex items-center justify-center shadow-minimal group-hover:scale-110 transition-all duration-700">
