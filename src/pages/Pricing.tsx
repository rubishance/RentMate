                                ...
                                >
                                    {tier.badgeText && (
                                        <div className="absolute -top-4 inset-x-0 flex justify-center">
                                            <span className="bg-gradient-to-r from-primary to-cyan-500 text-white text-xs font-black px-2 sm:px-4 py-1 rounded-full shadow-lg uppercase tracking-widest">
                                                {tier.badgeText}
                                            </span>
                                        </div>
                                    )}
                                    ...
                                    <div className="flex items-center gap-2 sm:gap-4 mb-6">
                                        <div className={`p-2 sm:p-4 rounded-xl bg-white dark:bg-black/40 shadow-sm ${tier.color}`}>
                                    ...
                                    <div className="space-y-4 flex-1">
                                        {tier.features.map((feature, fIdx) => (
                                            <div key={fIdx} className="flex items-center gap-2 sm:gap-4 text-sm">
                                    ...
                                    <button
                                        ...
                                        className={`w-full mt-8 py-2 sm:py-4 rounded-xl font-bold transition-all ${tier.buttonVariant === 'primary'
