                ...
                <div className="w-full px-5">
                    ...
                    <div className="mt-12 flex flex-col md:flex-row gap-6 relative z-10">
                        <div className="flex-1 relative group">
                            <Search className="absolute left-6 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground opacity-30 group-focus-within:opacity-100 group-focus-within:text-primary transition-all" />
                            <input
                                type="text"
                        ...
                        {filteredArticles.map((article) => (
                            ...
                            >
                                ...
                                <div className="flex items-start justify-between mb-8 relative z-10">
                                    ...
                                    <span className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-muted-foreground opacity-70">
                                ...
                                <div className="flex-1 space-y-4 relative z-10 mb-8">
                                    <h2 className="text-xl md:text-2xl font-black text-foreground tracking-tighter leading-tight group-hover:text-primary transition-colors lowercase">
                                ...
                                <div className="flex items-center justify-between pt-6 border-t border-white/5 relative z-10">
                                    ...
                                    <span className="button-jewel px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest text-white shadow-sm group-hover:scale-105 transition-all">
                                        {t('read_more')}
                                    </span>
                                </div>
                            </article>
