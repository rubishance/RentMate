            ...
            {isEditing && (
                <div className="bg-white dark:bg-gray-800 rounded-2xl border-2 border-primary-500 p-8 shadow-2xl space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label className="block text-xs font-black text-muted-foreground uppercase tracking-widest mb-2">Type</label>
                            <select
                                value={form.type}
                        ...
                        <div>
                            <label className="block text-xs font-black text-muted-foreground uppercase tracking-widest mb-2">Expiry Date (Optional)</label>
                            <input
                                type="datetime-local"
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-xs font-black text-muted-foreground uppercase tracking-widest mb-2">Target Link (Optional)</label>
                            <input
                                type="text"
