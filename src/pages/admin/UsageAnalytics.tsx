    ...
    if (error) {
        return (
            <div className="p-8 text-center bg-red-50 dark:bg-red-900/10 rounded-3xl border border-red-100 dark:border-red-900/20">
                ...
                <button
                    onClick={fetchStats}
                    className="px-6 py-2 bg-red-500 text-white rounded-xl font-bold hover:bg-destructive transition"
                >
                    Retry
                </button>
            </div>
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 bg-muted/50 dark:bg-neutral-800 p-1 rounded-2xl border border-slate-200 dark:border-neutral-700">
                                ...
                                <tr key={user.user_id} className="group hover:bg-background/50 dark:hover:bg-neutral-800/20 transition-colors border-b border-slate-50 dark:border-neutral-800 last:border-0">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <div className="flex-1 h-2 max-w-[100px] bg-muted/50 dark:bg-neutral-800 rounded-full overflow-hidden">
                                                <div
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="font-bold text-foreground">{formatNumber(user.event_count)}</span>
                                    </td>
