                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                ...
                                <div>
                                    <div className="text-sm text-gray-500 dark:text-gray-400">{isRtl ? 'דואר אלקטרוני' : 'Email'}</div>
                                    <a href="mailto:accessibility@rentmate.co.il" className="font-medium text-blue-600 hover:underline">
                            ...
                            <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                ...
                                <div>
                                    <div className="text-sm text-gray-500 dark:text-gray-400">{isRtl ? 'טלפון' : 'Phone'}</div>
                                    <a href="tel:+972501234567" className="font-medium text-blue-600 hover:underline">
                                        +972-50-123-4567
                                    </a>
                                </div>
                            </div>
