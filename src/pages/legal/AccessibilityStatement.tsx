                    ...
                    <GlassCard className="p-6 md:p-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-black/50 border border-white dark:border-slate-800 ring-1 ring-slate-900/5 dark:ring-white/10">
                        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-slate-300" dir="rtl">
                            <div className="flex items-center gap-3 mb-6">
                                <h2 className="text-2xl font-bold m-0 text-slate-900 dark:text-white">הצהרת נגישות</h2>
                            ...
                            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">רמת הנגישות</h3>
                            ...
                            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">תיקונים והתאמות שבוצעו</h3>
                            ...
                            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">יצירת קשר בנושא נגישות</h3>
                            <p className="leading-relaxed">
                                אם נתקלתם בבעיה או שיש לכם הצעה לשיפור, נשמח לשמוע מכם.
                                ניתן לפנות לרכז הנגישות שלנו:
                            </p>
                            <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-700">
                                <p className="font-semibold text-slate-900 dark:text-white">פרטי רכז הנגישות:</p>
                                <ul className="list-none space-y-2 mt-4 text-slate-700 dark:text-slate-300">
