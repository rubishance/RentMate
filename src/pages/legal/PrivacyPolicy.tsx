                    ...
                    <GlassCard className="p-6 md:p-10 bg-card/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-black/50 border border-white dark:border-slate-800 ring-1 ring-slate-900/5 dark:ring-white/10">
                        {isRtl ? (
                            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-foreground/80" dir="rtl">
                                ...
                                <h3 className="text-xl font-bold text-foreground mt-8 mb-4">4. זכויות המשתמש (עיון, תיקון ומחיקת מידע)</h3>
                                ...
                                <h3 className="text-xl font-bold text-foreground mt-8 mb-4">6. עוגיות (Cookies) ואמצעי מעקב</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-foreground mt-8 mb-4">7. יצירת קשר</h3>
                                <p className="leading-relaxed">
                            ...
                            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-foreground/80" dir="ltr">
                                ...
                                <h3 className="text-xl font-bold text-foreground mt-8 mb-4">4. User Rights (Review, Edit, and Delete)</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-foreground mt-8 mb-4">5. Data Security</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-foreground mt-8 mb-4">6. Cookies and Tracking</h3>
                                <p className="leading-relaxed">
