        ...
        <div className="relative min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 overflow-hidden font-hebrew" dir={isRtl ? 'rtl' : 'ltr'}>
            ...
            <div className="relative z-10 pb-20 pt-8">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <GlassCard className="p-6 md:p-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-black/50 border border-white dark:border-slate-800 ring-1 ring-slate-900/5 dark:ring-white/10">
                        {isRtl ? (
                            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-slate-300" dir="rtl">
                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">מדיניות פרטיות - RentMate</h2>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">1. איסוף מידע</h3>
                                ...
                                <ul className="list-disc list-inside space-y-2 marker:text-primary-500">
                                    <li><strong className="text-slate-900 dark:text-white">פרטי זיהוי והתקשרות:</strong> שם מלא, כתובת אימייל, ומספר טלפון.</li>
                                    <li><strong className="text-slate-900 dark:text-white">פרטי נכסים וחוזים:</strong> כתובות נכסים, נתוני חוזים, מועדי תחילה וסיום, וסכומי תשלום המנוהלים במערכת על ידך.</li>
                                    <li><strong className="text-slate-900 dark:text-white">מידע טכני ומזהים:</strong> כתובת IP, סוג דפדפן, נתוני גלישה וזמן גישה (Cookies) המשמשים לתפעול ואבטחת המערכת.</li>
                                </ul>
                                <p className="leading-relaxed"><strong className="text-slate-900 dark:text-white">חובת מסירת המידע:</strong> אינך חייב/ת על פי חוק למסור מידע זה, אולם ללא מסירת פרטי החובה (כגון אימייל לצורך יצירת חשבון), לא נוכל לספק לך את שירותי המערכת.</p>

                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">2. מטרות השימוש במידע</h3>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">3. העברת מידע לצדדים שלישיים</h3>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">4. זכויות המשתמש (עיון, תיקון ומחיקת מידע)</h3>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">5. אבטחת מידע</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">6. עוגיות (Cookies) ואמצעי מעקב</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">7. יצירת קשר</h3>
                                <p className="leading-relaxed">
                            ...
                            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-slate-300" dir="ltr">
                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Privacy Policy - RentMate</h2>
                                <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Last Updated: {lastUpdatedDate}</p>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">1. Information Collection</h3>
                                ...
                                <ul className="list-disc list-inside space-y-2 marker:text-primary-500">
                                    <li><strong className="text-slate-900 dark:text-white">Identity and Contact Info:</strong> Full name, email address, and phone number.</li>
                                    <li><strong className="text-slate-900 dark:text-white">Property and Contract Info:</strong> Property addresses, contract details, start/end dates, and payment amounts managed by you on the platform.</li>
                                    <li><strong className="text-slate-900 dark:text-white">Technical Information:</strong> IP address, browser type, usage data, and Cookies, to ensure operations and security.</li>
                                </ul>
                                <p className="leading-relaxed"><strong className="text-slate-900 dark:text-white">Obligation to Provide Data:</strong> You are not legally obligated to provide this data. However, without basic details like your email, we cannot create your account or provide the service.</p>

                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">2. Purposes of Use</h3>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">3. Disclosure to Third Parties</h3>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">4. User Rights (Review, Edit, and Delete)</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">5. Data Security</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">6. Cookies and Tracking</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">7. Contact Us</h3>
                                <p className="leading-relaxed">
