                    ...
                    <GlassCard className="p-6 md:p-10 bg-card/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-black/50 border border-white dark:border-slate-800 ring-1 ring-slate-900/5 dark:ring-white/10">
                        {isRtl ? (
                            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-foreground/80" dir="rtl">
                                ...
                                <p className="leading-relaxed">
                                    כל זכויות הקניין הרוחני הקשורות לפלטפורמה שמורות ל-RentMate. זה כולל, בין היתר, את זהות המותג "RentMate", הדמות הקמעית והלוגו "רנטי" (Renty the Raccoon), קוד התוכנה, אלגוריתמי בינה מלאכותית (AI) ומבני מתודולוגיה, וכן את כל עיצובי הממשק (UX/UI). אין להעתיק, לשעתק, להפיץ, או לעשות הנדסה חוזרת לכל חלק מאלה ללא אישור מפורש מראש ובכתב מ-RentMate. המידע הנוגע לנכסיך (דיירים וחוזים) שייך לך בלבד.
                                </p>
                            ...
                            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-foreground/80" dir="ltr">
                                ...
                                <p className="leading-relaxed">
                                    All intellectual property rights associated with the platform are exclusively retained by RentMate. This includes, but is not limited to, the "RentMate" brand identity, the "Renty the Raccoon" mascot and logo, the software codebase, AI algorithms and methodological structures, as well as all User Interface and User Experience (UX/UI) designs. You may not copy, reproduce, distribute, or reverse engineer any part of these assets without explicit prior written authorization from RentMate. The real estate data and tenant artifacts generated by you remain your property.
                                </p>
