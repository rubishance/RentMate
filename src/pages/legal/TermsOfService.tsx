                    ...
                    <GlassCard className="p-6 md:p-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-black/50 border border-white dark:border-slate-800 ring-1 ring-slate-900/5 dark:ring-white/10">
                        {isRtl ? (
                            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-slate-300" dir="rtl">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">1. השירות</h3>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">2. שימוש הוגן (Fair Use)</h3>
                                ...
                                <ul className="list-disc list-inside space-y-2 marker:text-primary-500">
                                    <li><strong className="text-slate-900 dark:text-white">זהות המשתמש:</strong> החשבון הינו אישי למשתמש או לתאגיד נרשם. שיתוף סיסמאות מחוץ להתקשרות המותרת בתוכנית מוגדר כהפרה בוטה של השימוש.</li>
                                    <li><strong className="text-slate-900 dark:text-white">מכסות משאבים:</strong> גבולות השימוש (כמות נכסים, זיכרון ואחסון מסמכים) מוגבלים לחבילת המנוי בה בחרת. יש לשמור על מסגרת השימוש המוקצית.</li>
                                    <li><strong className="text-slate-900 dark:text-white">כלים תבוניים:</strong> השימוש בכלי ה-AI ובוטים האוטומטיים נועד למטרות המערכת בלבד. ניסיון לפרוץ, לאמן במכוון נתוני שווא או למשוך מידע באופן לא סביר, הינו עבירה שתוביל להרחקתך לצמיתות.</li>
                                </ul>

                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">3. איסור על שימוש לרעה (Abuse)</h3>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">4. הגבלת אחריות</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">5. קניין רוחני</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">6. פרטיות והסכמה להעברת מידע</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">7. סמכות שיפוט ודין חל</h3>
                                <p className="leading-relaxed">
                            ...
                            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-slate-300" dir="ltr">
                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Terms of Service and Fair Use</h2>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">1. The Service</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">2. Fair Use</h3>
                                ...
                                <ul className="list-disc list-inside space-y-2 marker:text-primary-500">
                                    <li><strong className="text-slate-900 dark:text-white">User Identity:</strong> Your account is strictly personal or assigned to your legal entity. Sharing passwords with unassociated parties is strictly prohibited.</li>
                                    <li><strong className="text-slate-900 dark:text-white">Resource Quotas:</strong> Resource limits (properties count, file storage, chat) are governed by the subscription plan chosen. Attempts to circumvent these controls are prohibited.</li>
                                    <li><strong className="text-slate-900 dark:text-white">Intelligent Tools:</strong> AI bots and tools provided are for standard application purposes only. Scraping, hostile prompts, or unnatural bulk executions will result in a permanent ban.</li>
                                </ul>

                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">3. Abuse Prohibition</h3>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">4. Limitation of Liability</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">5. Intellectual Property</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">6. Privacy & Data Authorization</h3>
                                <p className="leading-relaxed">
                                ...
                                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">7. Jurisdiction</h3>
                                <p className="leading-relaxed">
