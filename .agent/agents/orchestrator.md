...
model: inherit
skills: clean-code, parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, ui-ux-pro-max, lint-and-validate, powershell-windows, bash-linux
---
