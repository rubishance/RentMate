...
COMMENT ON TABLE index_bases IS 'Stores historical index base periods and their linkage coefficients (m׳§׳“׳׳™ ׳§׳©׳¨)';
...
-- Add comment
COMMENT ON TABLE chaining_factors IS 'Stores CBS base year transition factors (׳׳§׳“׳ ׳׳§׳©׳¨) for accurate cross-base index calculations';
